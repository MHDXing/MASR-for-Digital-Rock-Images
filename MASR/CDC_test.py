...
# Test Options
parser.add_argument('--overlap', type=int, default=0, help='Overlap pixel when Divide input image, for edge effect')  # 24,64
parser.add_argument('--psize', type=int, default=25, help='Overlap pixel when Divide input image, for edge effect')   # 96,256
parser.add_argument('--real', type=bool, default=False, help='Whether to downsample input image')  # True
parser.add_argument('--cat_result', type=bool, default=False, help='Concat result to one image')
parser.add_argument('--has_GT', type=bool, default=True, help='the low resolution image size')  # True
...
parser.add_argument('--inc', type=int, default=3, help='the low resolution image channel')
parser.add_argument('--in_ch', type=int, default=3, help='the low resolution image channel')
parser.add_argument('--out_ch', type=int, default=3, help='the low resolution image channel')
parser.add_argument('--scala', type=int, default=4, help='the low resolution image size')
parser.add_argument('--scale', type=int, default=(4, 4), help='sr scale for test')
parser.add_argument('--n_HG', type=int, default=6, help='the low resolution image size')  # 6
...
parser.add_argument('--n_resgroups', type=int, default=10, help='number of residual groups')   # rcan 10,16,20,64; edsr 32,256
...
## Barely change
parser.add_argument('--pretrain', type=str, default='./models/HGSR-MHR_X4_best.pth')
