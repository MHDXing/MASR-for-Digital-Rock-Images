...
def parse_config(local_test=True):
    ...
    parser.add_argument('--test_dataroot', type=str, default='../../3CDC/CDC/unknown/time')  # little_
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--size', type=int, default=12, help='Size of low resolution image')  # 12
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='edsr_x4', help='')
    ...
    parser.add_argument('--decay_step', type=list, default=[160, 200, 230], help='')  # [160, 225, 275]
    ...
    parser.add_argument('--clipping_threshold', type=float, default=1e8, help='clipping_threshold')

    ## SRModel Settings
    # parser.add_argument('--pretrain', type=str, default='./models/CDCX_X4_best.pth')
    parser.add_argument('--pretrain', type=str, default='')
    parser.add_argument('--model', type=str, default='EDSR', help='[RRDB_net | srresnet | EDSR | RCAN | HGSR | HGSR-MHR]')
    ...
    parser.add_argument('--inte_loss_weight', type=list, default=[1, 1, 1, 3], help='flat,edge,corner,GW loss')  #[1, 2, 5, 1] 3251
