...
def parse_config(local_test=True):
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='masr_x4', help='')
    parser.add_argument('--generatorLR', type=float, default=2e-4, help='learning rate for SR generator')
    parser.add_argument('--warm_up', type=float, default=0, help='learning rate warm up')  # 4
    ...
    parser.add_argument('--clipping_threshold', type=float, default=20, help='clipping_threshold')

    ## SRModel Settings
    # parser.add_argument('--pretrain', type=str, default='./models/CDCX_X4_best.pth')
    parser.add_argument('--pretrain', type=str, default='')
    parser.add_argument('--model', type=str, default='MASR', help='[RRDB_net | srresnet | EDSR | RCAN | HGSR | HGSR-MHR]')
    ...
    parser.add_argument('--inte_loss_weight', type=list, default=[1, 2, 5, 1], help='flat,edge,corner,GW loss')  #[1, 2, 5, 1]1751
